...
<style>
    ...
    .stButton > button {
        background-color: #00d2ff !important; /* Force Neon Cyan */
        color: #000000 !important;            /* Force Black Text */
        border: 2px solid #0099cc !important; /* Solid Border */
        padding: 15px 25px;
        border-radius: 10px;
    ...
    .stButton > button:hover {
        background-color: #00aaff !important; /* Darker Blue on Hover */
...
st.sidebar.markdown("`v5.3 | FINAL BUILD`")
