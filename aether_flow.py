...
st.markdown('<div class="main-title">  AETHER APEX v15.0</div>', unsafe_allow_html=True)
...
# --- TAB 4: PORTFOLIO (NEW HOME FOR ASSETS & TOOLS) ---
with tab4:
    # 1. VISUAL DASHBOARD (Moved from Account)
    ...
    # 2. HEDGE FUND OPTIMIZER (Moved from Tools)
