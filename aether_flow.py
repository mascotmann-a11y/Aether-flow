...
st.set_page_config(
    layout="wide", 
    page_title="AETHER APEX v27.0", 
    page_icon=" ", 
    initial_sidebar_state="collapsed" 
)

# NEW DB NAME FOR V27
DB_NAME = 'aether_v27.db'
...
# --- 3. CSS STYLING (V27 CYBER-GLASS ENGINE) ---
st.markdown("""
<style>
    /* V27 GLOBAL MOBILE RESET */
    .stApp {
    ...
    .stTabs [data-baseweb="tab"] {
        ...
        border-radius: 12px; color: #888; font-size: 13px; font-weight: 600; 
        padding: 0 15px; border: 1px solid rgba(255, 255, 255, 0.05);
        flex: 1 0 auto; /* Allow scrolling on small screens */
    }
    ...
    div.stButton > button {
        ...
        width: 100%; border-radius: 14px; height: 60px; /* V27 Mobile Size */
...
st.markdown('<div class="main-title">AETHER APEX v27.0</div>', unsafe_allow_html=True)
