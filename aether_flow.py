...
st.set_page_config(
    layout="wide", 
    page_title="AETHER APEX v29.0", 
    page_icon=" ", 
    initial_sidebar_state="collapsed" 
)

# NEW DB NAME FOR V29
DB_NAME = 'aether_v29.db'
...
# --- 3. CSS STYLING (V29: NEON & BLACK) ---
st.markdown("""
<style>
    /* V29: GLOBAL DARK & NEON THEME */
    .stApp {
        background-color: #050505; 
        color: #e0e0e0; /* Default Text: Light Grey */
        font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;
    }
    
    /* V29: HEADERS - NEON BLUE (No More White) */
    ...
    /* V29: BUTTONS (INVERTED - BLACK BG, NEON TEXT) */
    div.stButton > button {
        background: #000000 !important; 
        color: #00d2ff !important; 
    ...
    /* V29: EXPANDER FIX (Force Dark Background) */
    ...
    .stTextInput>div>div>input, .stNumberInput>div>div>input, .stSelectbox>div>div {
        background-color: #111111 !important; color: #00d2ff !important;
        border: 1px solid #333 !important; border-radius: 10px;
        height: 45px;
    }
...
st.markdown('<div class="main-title">AETHER APEX v29.0</div>', unsafe_allow_html=True)
...
with tab5:
    ...
    st.markdown('<div class="cc-form" style="background: #111111; border: 1px solid #00d2ff;">', unsafe_allow_html=True)
...
with tab8:
    ...
    st.markdown("""
    <div style='background-color: #111111; padding: 15px; border-left: 5px solid #00d2ff; border-radius: 5px; border: 1px solid #333;'>
        <strong style='color: #00d2ff'>PROTOCOL: GHOST_MODE</strong><br>
