...
st.set_page_config(
    layout="wide", 
    page_title="AETHER APEX v24.0", 
    page_icon=" ", 
    initial_sidebar_state="collapsed" 
)

# NEW DB NAME FOR V24
DB_NAME = 'aether_v24.db'
...
st.markdown('<div class="main-title">  AETHER APEX v24.0</div>', unsafe_allow_html=True)
...
# TABS
tab1, tab2, tab3, tab4, tab5, tab6, tab7 = st.tabs(["Trade", "Chat", "Scan", "Portfolio", "Account", "Intel Center", "Time Machine"])
